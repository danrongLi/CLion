...
//    cout << z; //5
    ...
    func4(20);
    Thing oneThing;
    oneThing.setItem(100);
    Thing twoThing;
    twoThing.setItem(500);
    cout << oneThing.getItem() << endl; //100
    cout << twoThing.getItem() << endl; //500
    ...
    cout << *oneThing.getPointer() << endl;  //same as *(oneThing.getPointer())
