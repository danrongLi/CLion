...
void RBT<T>::singleRight(RBTNode<T> *&point) {
    ...
    grandparent->left = parent->right; //down!
    if (parent->right != nullptr){
        parent->right->parent = grandparent;
    }
    parent->parent = grandparent->parent; //up!
    ...
    parent->right = grandparent; //each other!
...
void RBT<T>::singleLeft(RBTNode<T> *&point) {
    ...
    // TODO: ADD ROTATION CODE HERE
    grandparent->right = parent->left; //down!
    ...
    parent->left = grandparent; //each other!
    grandparent->parent = parent;
}
            ...
            if (curr_node->parent->parent->left == curr_node->parent){
                ...
                if (getColor(uncle) == RED){
                    ...
                    if (curr_node->parent->left == curr_node){
                        ...
                        swapColor(curr_node->parent->parent);
                        swapColor(curr_node);
                        leftRight(curr_node->parent->parent);
                ...
                if (getColor(uncle) == RED){
                    ...
                    if (curr_node->parent->right == curr_node){
                        ...
                        swapColor(curr_node->parent->parent);
                        swapColor(curr_node);
                        rightLeft(curr_node->parent->parent);
